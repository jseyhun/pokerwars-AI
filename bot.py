...
def play():
    ...
    print('Game info received for tournament ' + str(game_info["tournamentId"]) + ' and round ' + str(
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                r = requests.post('https://play.pokerwars.io/v1/pokerwars/subscribe',
                                  json={'username': username, 'token': api_token, 'botEndpoint': bot_endpoint,
